...
import datetime
from modelo.Dados import b_periodo
...
# Primeira camada LSTM com 500 unidades e retorno das sequências
model.add(LSTM(175, return_sequences=True, input_shape=(window_size, 6)))
...
# Camada Densa final com ativação sigmoid (para previsão binária, por exemplo)
...
plt.legend()
plt.savefig(f"./Previsoes/Re2{datetime.datetime.now().time()}.png")
plt.show()
